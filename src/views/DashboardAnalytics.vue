    ...
    <div class="vx-row">
      ...
      <div class="vx-col w-full lg:w-1/2 mb-base">
        <vx-card slot="no-body" class="text-center bg-primary-gradient greet-user">
          ...
          <p class="xl:w-3/4 lg:w-4/5 md:w-2/3 w-4/5 mx-auto text-white">You have done <strong>{{ checkpointReward.progress }}</strong> more interviews today.</p>
        </vx-card>
      </div>

      <!-- CARD 2: SUBSCRIBERS GAINED -->
      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        <statistics-card-line icon="UsersIcon" statistic="92.6k" statisticTitle="Interviews Done" :chartData="subscribersGained.series" type="area"></statistics-card-line>
      </div>

      <!-- CARD 3: ORDER RECIEVED -->
      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        <statistics-card-line icon="ShoppingBagIcon" statistic="97.5K" statisticTitle="Candidates Applied" :chartData="ordersRecevied.series" color="warning" type="area"></statistics-card-line>
      </div>
    </div>
    ...
    <div class="vx-row">
      ...
      <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
        ...
        <div class="vx-row">
            ...
            <!-- CARD 7: Sales Stats -->
            <div class="vx-col w-full lg:w-1/3 mb-base">
              <vx-card title="Recruitment Stats" subtitle="Last 6 Months">
                <template slot="actions">
      ...
      timelineData: [
        {
          ...
          desc: 'Scheduled interview for a product manager',
          time: '25 mins Ago'
        },
        {
          color: 'warning',
          ...
          desc: 'Scheduled recruitments for mobile developers',
          time: '15 Days Ago'
        },
        {
          color: 'danger',
          icon: 'UsersIcon',
          title: 'Plan Webinar',
          desc: 'Webinar for orientation of new recruited workers',
          time: '20 days ago'
        },
        {
          color: 'success',
          ...
          desc: 'Recruitment website launch',
          time: '25 days ago'
        },
        {
          color: 'primary',
          icon: 'TvIcon',
          title: 'Marketing',
          desc: 'Advertisement for the role of HR',
          time: '28 days ago'
        }
      ],
